...
const BUILTIN_MODELS: ModelMetadata[] = [
  ...
  { provider: 'doubao', modelName: 'doubao-seedance-2-0-mini-260615', modelType: 'video', displayName: '豆包 Seedance 2.0 Mini', description: '高性价比视频生成，480P/720P，4-15秒，支持首尾帧/全模态参考/编辑延长', supportsJson: false, supportsReferenceImages: true, supportsAudio: true, costPerVideo: 0.06 },
  { provider: 'doubao', modelName: 'doubao-seedance-2-0-fast-260128', modelType: 'video', displayName: '豆包 Seedance 2.0 Fast', description: '高速视频生成，成本与速度平衡，480P/720P，4-15秒，支持首尾帧/全模态参考', supportsJson: false, supportsReferenceImages: true, supportsAudio: true, costPerVideo: 0.09 },
  // 可灵
